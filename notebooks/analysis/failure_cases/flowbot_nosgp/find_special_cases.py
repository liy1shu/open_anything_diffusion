...
# success_rate_per_step[-1] * 1358 / 1532
success_rate_per_step = success_rate_per_step * total_sample_counts / 1532
# Make plots!!!
...
plt.title("Success Rate Inc per Step (FlowBotHD w/o SGP)")
plt.grid(True)
...
plt.ylim(-0.05, 1.05)
plt.xlim(-2, 32)
plt.title("Success Rate per Step (FlowBot w/o SGP)")
plt.grid(True)
