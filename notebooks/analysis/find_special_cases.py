...
if special_type == "occlusion":  # --- Special case 1 : Occlusions ---
    ...
    failure_txt = "./flowbotHD_failure_ids_whf.txt"
    ckpt_file = (
    ...
    model = FlowTrajectoryDiffuserInferenceModule_HisPNDiT(
